<script lang="ts">
	import DangerButton from './danger-button.svelte';
	...
	import SuccessButton from './success-button.svelte';
	import WarningButton from './warning-button.svelte';

	let { onclick, type, disabled, loading, children } = $props<{
