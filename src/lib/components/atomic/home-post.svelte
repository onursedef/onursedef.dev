...
>
	...
	<div class="flex w-4/5 flex-col gap-2">
		...
		<p class="font-light">{post.short_description}</p>
		<span class="inline-flex items-center gap-1 text-xs text-gray-700 dark:text-gray-400"
			><Eye class="h-5 w-5" /> {post.view_count}</span
		>
	</div>
</a>
